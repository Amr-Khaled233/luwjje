...
export const settingsSchema = z.object({
  ...
  announcementTextAr: z.string().trim().max(160).default(''),
  showAbout: z.boolean().default(true),
  showJournal: z.boolean().default(true),
  showFooterLinks: z.boolean().default(true),
  showFooterSocial: z.boolean().default(true),
  footerLinksHeading: z.string().trim().max(60).default(''),
  footerLinksHeadingAr: z.string().trim().max(60).default(''),
  footerSocialHeading: z.string().trim().max(60).default(''),
  footerSocialHeadingAr: z.string().trim().max(60).default(''),
  footerRights: z.string().trim().max(120).default(''),
  footerRightsAr: z.string().trim().max(120).default(''),
