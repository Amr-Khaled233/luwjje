    ...
    <div className="flex flex-col gap-8">
      ...
      <SettingsManager
        settings={{
          ...
          showFooterSocial: settings.showFooterSocial,
          footerLinksHeading: settings.footerLinksHeading,
          footerLinksHeadingAr: settings.footerLinksHeadingAr,
          footerSocialHeading: settings.footerSocialHeading,
          footerSocialHeadingAr: settings.footerSocialHeadingAr,
          footerRights: settings.footerRights,
          footerRightsAr: settings.footerRightsAr,
